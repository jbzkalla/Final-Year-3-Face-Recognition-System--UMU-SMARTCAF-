...
def generate_excel_with_logo(data_rows, headers, title="Report", filename="report.xlsx"):
    ...
    # 1. Add Logo
    logo_path = r"c:\Users\HP G3\Desktop\Bwanika Joseph Final Year3 Project\Bwanika Joseph Final UMU SmartCaf Project\Bwanika Joseph Final UMU SmartCaf Project\umu_logo.jpeg"
